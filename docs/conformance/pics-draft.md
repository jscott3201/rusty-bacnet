...
| `BACNET-AB-SC-FRAME` | Annex AB.2 | implementation-present-needs-negative-tests | `crates/bacnet-transport/src/sc_frame.rs`, `crates/bacnet-transport/src/sc/data_attributes.rs`, `crates/bacnet-transport/src/sc/data_attribute_tests.rs`, `crates/bacnet-transport/src/sc/mod.rs` |
| `BACNET-AB-SC-BVLC-RESULT` | Annex AB.2.4 | implementation-present-needs-conformance-tests | `crates/bacnet-transport/src/sc_frame.rs`, `crates/bacnet-transport/src/sc_frame/result.rs`, `crates/bacnet-transport/src/sc/data_attributes.rs`, `crates/bacnet-transport/src/sc/data_attribute_tests.rs`, `crates/bacnet-transport/src/sc/mod.rs`, `crates/bacnet-transport/src/sc/result_tests.rs` |
