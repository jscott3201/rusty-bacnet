...
| `BACNET-12-LOG-STATUS-LIFECYCLE` | Clause 12.25 Trend Log (pp. 319-336); Clause 12.27 Event Log (pp. 337-346); Clause 12.30 Trend Log Multiple (pp. 361-378); Clause 21.6 BACnetLogStatus (p. 914); Clause 12.25 Log_Buffer acquisition timestamps (PDF p. 320 / printed p. 318); Clause 20.2.12 local actual Date (PDF p. 848 / printed p. 846); Clause 20.2.13 local actual Time (PDF p. 849 / printed p. 847) | P1 | in-progress | 0 |
