...
| `BACNET-19-SOURCE-READ-PROPERTY` | Clause 19.6 / Tables 19-3, 19-4, 19-5; Clause 18.7; Clause 12.63 | P1 | in-progress | 4 |
...
| `BACNET-AB-SC-CONNECTION-STATE` | Annex AB.6.2 | P0 | implementation-present-needs-state-machine-audit | 11 |
