...
| `BACNET-12-LOG-STATUS-LIFECYCLE` | Clause 12.25 Trend Log (pp. 319-336); Clause 12.27 Event Log (pp. 337-346); Clause 12.30 Trend Log Multiple (pp. 361-378); Clause 21.6 BACnetLogStatus (p. 914); Clause 12.25 Log_Buffer acquisition timestamps (printed p. 320); Clauses 20.2.12-20.2.13 local actual Date/Time (printed p. 849) | P1 | in-progress | 0 |
