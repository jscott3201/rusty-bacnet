...
| `BACNET-13-EVENT-ENROLLMENT-NOTIFICATION-LIFECYCLE` | Clause 12.12 (Event Enrollment Event_Type, Event_Enable, Notification_Class, Acked_Transitions, Event_Time_Stamps and Event_Message_Texts); Clause 13.2.2.1.4 (commit before indication/distribution, including same-state indication); Clause 13.2.3 (transition acknowledgment state and Notification Class Ack_Required); Clause 13.2.5, 13.2.5.2 Table 13-3 and 13.2.5.3 Table 13-5 (distribution gate and committed notification fields) | P1 | implementation-present-needs-conformance-tests | 0 |
