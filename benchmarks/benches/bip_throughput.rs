...
use bacnet_benchmarks::helpers::{make_bip_client, make_bip_server};
...
fn bench_read_property_throughput(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("bip_read_property_throughput");
...
fn bench_write_property_throughput(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("bip_write_property_throughput");
